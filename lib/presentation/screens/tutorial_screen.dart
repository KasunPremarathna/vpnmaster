...
class TutorialScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('App Tutorial & Guide',
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildExpansionTile(
            ...
            content:
                'To use the app, first open the drawer menu and go to the "Servers" list to select a VPN profile. You can either pick a default server or build your own custom profile using the "Payload Builder". Once selected, return to the Home Screen and tap the large CONNECT button.',
          ),
          ...
          _buildExpansionTile(
            ...
            content:
                'A custom payload is a special HTTP injection string used to trick your ISP\'s firewall or billing system into thinking you are accessing allowed zero-rated websites (like social media or university sites), while actually tunneling internet traffic directly to the VPN.\n\nThe Custom Payload field allows you to type raw HTTP headers before the SSH handshake happens.',
          ),
          const SizedBox(height: 12),
          _buildExpansionTile(
            context: context,
          ...
          children: [
            Align(
              ...
              child: SelectableText(
                content,
                style: TextStyle(
                    color: Colors.grey.shade300, height: 1.6, fontSize: 14),
              ),
            ),
          ],
        ),
